...
bool StartWebServer() {
    PHP_DESKTOP_LOG_INFO << "Starting PHP built-in web server";
    ...
    PHP_DESKTOP_LOG_INFO << "Web server url: " << g_webServerUrl;
    ...
    PHP_DESKTOP_LOG_INFO << "PHP executable: " << phpExecutable;
...
void StopWebServer() {
    PHP_DESKTOP_LOG_INFO << "Stopping PHP built-in web server";
