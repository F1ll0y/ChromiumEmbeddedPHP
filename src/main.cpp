    ...
    switch (uMsg) {
        case WM_SIZE:
            ...
            if (browser && browser->GetCefBrowser()) {
                ...
                PHP_DESKTOP_LOG_WARNING << "WindowProc() WM_SIZE: could not fetch BrowserWindow";
            }
            break;
        case WM_MOVE:
        case WM_MOVING:
        case WM_SIZING:
            ...
            if (browser && browser->GetCefBrowser()) {
                ...
                PHP_DESKTOP_LOG_WARNING << "WindowProc() WM_MOVE: could not fetch BrowserWindow";
            }
            return 0;
        case WM_CREATE:
            ...
            return 0;
        case WM_DESTROY:
            PHP_DESKTOP_LOG_DEBUG << "WM_DESTROY";
        ...
        case WM_GETMINMAXINFO:
            ...
            if (browser) {
                ...
                PHP_DESKTOP_LOG_DEBUG << "WindowProc(): event WM_GETMINMAXINFO: "
        ...
        case WM_SETFOCUS:
            ...
            if (browser) {
                ...
                PHP_DESKTOP_LOG_DEBUG << "WindowProc(): event WM_SETFOCUS: "
                             "could not fetch BrowserWindow";
            }
            break;
        case WM_ERASEBKGND:
        ...
        case WM_SYSCOMMAND:
            if (wParam == SC_MINIMIZE && minimize_to_tray) {
                PHP_DESKTOP_LOG_DEBUG << "Minimize to tray";
        ...
        case WM_TRAY_MESSAGE:
            if (lParam == WM_LBUTTONDOWN || lParam == WM_RBUTTONDOWN) {
                PHP_DESKTOP_LOG_DEBUG << "Restore from tray";
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,
    ...
    if (argv) {
        ...
        PHP_DESKTOP_LOG_WARNING << "CommandLineToArgvW() failed";
    }
    ...
    PHP_DESKTOP_LOG_INFO << "Started application";

    if (log_file.length())
        PHP_DESKTOP_LOG_INFO << "Logging to: " << log_file;
    else
        PHP_DESKTOP_LOG_INFO << "No logging file set";
    PHP_DESKTOP_LOG_INFO << "Log level = "
    ...
    if (remote_debugging_port > 0) {
        PHP_DESKTOP_LOG_INFO << "remote_debugging_port = " << remote_debugging_port;
